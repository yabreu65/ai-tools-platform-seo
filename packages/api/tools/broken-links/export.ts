...
export class ExportService {
  async export(results: AnalysisResults, format: string): Promise<string> {
  ...
  private exportToCSV(results: AnalysisResults): string {
    const headers = [
      'URL Origen',
      'URL Destino', 
      'Código de Estado',
  ...
  private exportToPDF(results: AnalysisResults): string {
