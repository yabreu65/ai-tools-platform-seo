...
exports.scrapeWithTor = void 0;
exports.getPageWithTor = getPageWithTor;
const puppeteer_1 = __importDefault(require("puppeteer"));
const cheerio = __importStar(require("cheerio"));
function getPageWithTor(url) {
...
const scrapeWithTor = (url) => __awaiter(void 0, void 0, void 0, function* () {
    const browser = yield puppeteer_1.default.launch({
        headless: true,
        args: [
            '--no-sandbox',
...
exports.scrapeWithTor = scrapeWithTor;
