...
router.post('/keywords/compare', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/backlinks/analyze', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { domains, filters } = req.body;
...
router.post('/content/analyze', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { domains, filters } = req.body;
        if (!domains || !Array.isArray(domains) || domains.length === 0) {
            res.status(400).json({ error: 'Se requiere al menos un dominio' });
        ...
        const mockResult = {
            ...
            contentAnalysis: domains.map((domain) => ({
                domain,
            ...
            competitorContent: domains.map((domain) => ({
                domain,
...
router.post('/reports/generate', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/alerts/configure', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
